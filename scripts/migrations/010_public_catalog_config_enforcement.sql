...
-- La publicación visual también gobierna la exposición real del catálogo.
-- La vista sigue ocultando costo y metadata interna, y ahora falla cerrada
-- cuando el administrador deshabilita o privatiza el catálogo.
...
VALUES (
  '010',
  'public_catalog_config_enforcement',
  'sha256-public-catalog-config-enforcement-010-v1',
  true,
  'migration-engine'
)
