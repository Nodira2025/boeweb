...
- Comprobación del recurso real: el video guardado (`9bGbnJJT_FQ`) muestra el aviso de YouTube de restricción de edad y reproducción sólo en YouTube. La integración no puede eliminar esa restricción; hay que elegir otro recurso apto para inserción o usar el enlace externo. Se conservó el video elegido, sin sustituirlo por material de prueba.
- Verificación pública: se cargan los nuevos archivos, los enlaces usan el contacto publicado y siguen disponibles 7.215 ofertas nacionales y dos productos propios. La sesión del navegador no tenía acceso administrativo verificado; el editor completo se comprobó con datos simulados, no mediante una publicación real.
